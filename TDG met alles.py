...
while run:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            # Klik op de map om toren te plaatsen als er een gekocht is
            elif selected_tower_type:
                if selected_tower_type == "kanon":
                    towers.append(Tower(mouse_pos[0] - 32, mouse_pos[1] - 32, tower_kanon_image, range_radius=100, damage_per_second=20))
                elif selected_tower_type == "Boogschutterstoren":
                    towers.append(Tower(mouse_pos[0] - 32, mouse_pos[1] - 32, tower_boog_image, range_radius=120, damage_per_second=15))
                elif selected_tower_type == "Wizard toren":
                    towers.append(Tower(mouse_pos[0] - 32, mouse_pos[1] - 32, tower_wizard_image, range_radius=140, damage_per_second=10))

                selected_tower_type = None  # Reset na plaatsen
